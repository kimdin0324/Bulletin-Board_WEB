            ...
            <div class="col-lg-5 col-md-6 offset-lg-0 offset-md-3">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="formAction.jsp">
                    <div class="form-group">
                      	<td><input type="text" class="form-control" placeholder="이름_학번" name="formTitle" maxlength="50"></td>
                    </div>
                    
                    <div class="form-group">
							<td><input type="text" class="form-control" placeholder="전화번호" name="code" maxlength="50"></td>
                    </div>
                    
                    <div class="form-group">
							<td><textarea class="form-control" placeholder="자기소개" name="formContent" maxlength="2048" style="height: 350px;"></textarea></td>
                    </div>
              ...
              <div class="alert alert-warning alert-with-icon">
                <button type="button" aria-hidden="true" class="close" data-dismiss="alert" aria-label="Close">
                 ...
                 <span><b> Warning! - </b><br>메모장에서 작성후 붙여넣기를 권장합니다.</span>
              </div>
