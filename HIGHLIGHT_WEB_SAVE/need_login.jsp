      ...
      <div class="container align-items-center">
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <h1 class="profile-title text-left">Login is required</h1>
            <h5 class="text-on-back">Login</h5>
            <p class="profile-description">이 페이지는 동아리 부원들의 활동 결과를 <br>보호하기 위해 회원가입과 로그인이 <br>필요한 서비스입니다 자세한 내용은<br>운영자에서 문의해주세요</p>
          </div>
          <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                <img src="/images/a.png" class="img-center img-fluid rounded-circle">
          </div>
        </div>
      </div>
    </div>
