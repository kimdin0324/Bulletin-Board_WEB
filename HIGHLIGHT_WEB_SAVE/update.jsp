                ...
                <div class="tab-content tab-subcategories">
                  ...
                  <form method="post" action="updateAction.jsp?bbsID=<%=bbsID%>">
					...
					<tbody>
						...
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="120000" style="height: 350px;"><%=bbs.getBbsContent()%></textarea></td>
						</tr>
					</tbody>
                      </table>
       ...
       <%
        ...
        <div class="alert alert-warning alert-with-icon">
          ...
          <div class="alert alert-warning alert-with-icon">
            ...
            <span data-notify="icon" class="tim-icons icon-bulb-63"></span>
            <span>
              <b> Tip! - </b> 수정시 Ctrl + A로 전체선택 후 복사해서 한글에서 수정을 권장합니다</span>
          </div>
      </div>
    </div>
